...
def main():
    ...
    for employer in employers_ids:
        ...
        # Получение вакансий
        data_vac = hh.get_vacancies_from_employer()

        # Добавление данных в таблицу
        db.add_data_employers_to_database(data_emp)

        # Добавление данных в таблицу
        db.add_data_vacancies_to_database(data_vac)
    ...
    while True:
        ...
        if user_input.lower() == "0":
            ...
            input_keyword = input(f"Введите компанию из списка {employer_names} ")
